<?php
   ...
   //new routes
   Route::get('/home/addprize',function(){  return view('addprize');})->middleware('auth:admin');
   Route::get('viewprize','AdminController@viewprize')->middleware('auth:admin');
   Route::get('employees',function(){  return view('admin.employee');});//->middleware('auth:admin');
   //Route::get('/home', 'HomeController@index')->name('home');
   //Route::get('viewprize','AdminController@viewprize')->middleware('auth:admin');
   //Route::get('/employee/{employee}/edit', 'AdminController@edit')->name('admin.employee.edit');
