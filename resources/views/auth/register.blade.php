                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="busnumber" type="text" class="form-control{{ $errors->has('busnumber') ? ' is-invalid' : '' }}" name="busnumber" value="{{ old('busnumber') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="currentplace" type="text" class="form-control{{ $errors->has('currentplace') ? ' is-invalid' : '' }}" name="currentplace" value="{{ old('currentplace') }}" required autofocus>

                                @if ($errors->has('currentplace'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('currentplace') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
